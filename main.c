...
#define NUM_CONSUMERS 4 // 消费者线程数量
...
volatile int running = 1; // 所有线程运行的全局标志
...
void* consumer_thread(void* arg) {
    ...
    long thread_id = (long)pthread_self(); // 获取线程ID
    printf("[线程 %ld] 启动成功。\n", thread_id);
